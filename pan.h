...
#define PanSource	"modelo_verificacion_spin.pml"
...
#define _nstates2	19	/* Consumidor */
#define minseq2	40
#define maxseq2	57
#define _endstate2	18

#define _nstates1	23	/* Worker */
#define minseq1	18
#define maxseq1	39
#define _endstate1	22

#define _nstates0	19	/* Productor */
#define minseq0	0
#define maxseq0	17
...
#define PConsumidor	((P2 *)_this)
typedef struct P2 { /* Consumidor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#endif
	uchar r;
	uchar workers_finalizados;
} P2;
#define Air2	(sizeof(P2) - Offsetof(P2, workers_finalizados) - 1*sizeof(uchar))
...
#define Air1	(sizeof(P1) - Offsetof(P1, t) - 1*sizeof(uchar))

#define PProductor	((P0 *)_this)
typedef struct P0 { /* Productor */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define HAS_TRACK	0
/* hidden variable: */	uchar total_unicos;
